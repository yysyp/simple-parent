...
import com.example.news.util.opslabJutil.bean.BeanStruct;
import com.example.news.util.opslabJutil.functions.PropertyFilter;
import com.example.news.util.opslabJutil.util.CheckUtil;
import com.example.news.util.opslabJutil.util.algorithmImpl.BeanFactory;
